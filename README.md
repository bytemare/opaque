...
- [OPAQUE in WhatsApp](https://www.whatsapp.com/security/WhatsApp_Security_Encrypted_Backups_Whitepaper.pdf) to enable end-to-end encrypted backups.
...
- Rate limiting and replay tracking are application responsibilities. OPAQUE authenticates transcripts, the session management is up to you.
...
- Client.ClearState() best-effort clears ephemeral material, but zeroization has language/runtime limits.
