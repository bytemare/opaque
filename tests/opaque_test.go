...
//		server := p.Server()
//
//		ke1d, err := server.DeserializeKE1(ke1s)
//		if err != nil {
//			t.Fatalf(dbgErr, p.Mode, err)
//		}
//
//		// Test fake credential response
//		//fakeRecord := &opaque.ClientRecord{
//		//	CredentialIdentifier: test.userID,
//		//	ClientIdentity:       test.userID,
//		//	RegistrationUpload:   &message.RegistrationUpload{
//		//		PublicKey:  input.FakeClientPublicKey,
//		//		MaskingKey: input.FakeMaskingKey,
//		//		Envelope:   make([]byte, server.EnvelopeSize, server.EnvelopeSize),
//		//	},
//		//	TestMaskNonce:        input.MaskingNonce,
//		//}
//		//
//		//ke2, err := server.FakeCredentials(ke1d, test.serverID, test.serverSecretKey, test.serverPublicKey,
//		//	test.userID, test.oprfSeed)
//		//if err != nil {
//		//	t.Fatalf(dbgErr, p.Mode, err)
//		//}
//
...
//
//		// Client
//		ke2d, err := client.DeserializeKE2(ke2s)
//		if err != nil {
//			t.Fatalf(dbgErr, p.Mode, err)
//		}
//
//		_, _, err = client.Finish(test.userID, test.serverID, ke2d)
//		if err == nil {
//			t.Fatalf("Expected error in Client Finish.")
//		}
//	}
//}
//